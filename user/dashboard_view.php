...
<!--Header-->
   ...
   <header class="fixed top-0 left-0 w-full bg-white/90 backdrop-blur-md shadow z-50">
    ...
    <!-- NAVBAR-->
    <nav class="border-t-2 border-gray-200/100 px-10 py-3 
flex justify-center gap-10 text-gray-700 font-medium 
max-w-6xl mx-auto">

        <a href="#" class="text-green-600 border-b-2 border-green-600 pb-1">
            Beranda
        </a>
...
style="background-image: url('../assets/img/BannerBg.png');">
        ...
        <div class="max-w-xl">
            ...
            <a href="#"
               class="inline-block bg-yellow-500 text-white px-6 py-3 rounded-full 
        ...
        <div class="w-[400px] h-[250px]rounded-xl flex items-center justify-center">
            <span class="text-gray-400"><img src="../assets/img/FotoLogin.png" alt="FotoDashboard" width="330"></span>
        </div>
        ...
        <div class="grid grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition">
                ...
                <div class="flex justify-end">
                    <button class="bg-yellow-400 p-2 rounded-full hover:bg-yellow-500 transition">
