...
<Main class="flex justify-center items-center min-h-[500px] bg-gray-50 py-16">
   <div class="flex items-center gap-24 max-w-6xl">
        <!--Konten Kiri-->
        <div>
            <img src="../assets//img/FotoLogin.png" alt="fotopetanilogin" width="300">
        </div>
        <!-- End Kiri-->
...
<div class="grid grid-cols-4 gap-10">
    ...
    <!-- BRAND -->
    <div>
        <img src="../assets/img/contrasLogoFlomart.png" class="w-40 mb-4">
        ...
        <div class="flex">
            ...
            class="px-3 py-2 rounded-l-lg text-black w-full  bg-white shadow">
